...
> **© License:** 교육 목적 자유 사용, 상업적 사용 및 무단 수정/배포 금지. 자세한 사항은 [LICENSE.md](../LICENSE.md)를 참고하세요.
...
| Topic | 설명 |
|---|---|
| **Git 기초** | 저장소 생성, 변경 사항 추가/커밋, 히스토리 확인, diff |
| **원격 저장소** | push/pull/fetch, 로컬 저장소와 원격 서버 연결 개념 |
| **변경 되돌리기** | reset, revert, restore로 작업 복구 |
...
| **유용한 도구** | tig, lazygit, gh, diff-so-fancy 등 |
| **FAQ** | 70개 이상의 실전 Q&A |
...
### 03. 원격 저장소 (Remote Repositories)
*   [원격 저장소 이해](03_원격_저장소/01_원격_저장소_이해.md)
*   [푸시, 풀, 페치](03_원격_저장소/02_Push_Pull_Fetch.md)
*   [Patch: 코드를 파일로 주고받기](03_원격_저장소/03_Patch_작업.md)

### 04. 변경 되돌리기 (Undoing Changes)
*   [Reset과 Revert](04_변경_되돌리기/01_Reset과_Revert.md)
*   [Checkout 사용하기](04_변경_되돌리기/02_Checkout_사용하기.md)

### 05. 브랜치와 병합 (Branching and Merging)
*   [브랜치란 무엇인가요?](05_브랜치와_병합/01_브랜치란.md)
*   [브랜치 생성, 전환 및 삭제](05_브랜치와_병합/02_브랜치_생성_전환_삭제.md)
*   [브랜치 병합](05_브랜치와_병합/03_브랜치_병합.md)
*   [병합 충돌 해결](05_브랜치와_병합/04_충돌_해결.md)
*   [Cherry-Pick: 특정 커밋만 가져오기](05_브랜치와_병합/05_Cherry_Pick.md)
