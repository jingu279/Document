...
지금까지의 작업은 모두 여러분의 로컬 컴퓨터에서 이루어졌습니다. 하지만 Git의 진정한 가치는 협업에서 드러납니다. **원격 저장소(Remote Repository)**를 사용하면 전 세계 어디서든 다른 개발자들과 함께 프로젝트를 개발할 수 있습니다. 이제 우리는 로컬 환경을 넘어 다른 개발자들과 협업할 수 있는 원격 저장소의 세계로 발을 내딛어보겠습니다. 원격 저장소를 이해하는 것은 Git을 이용한 협업의 첫걸음입니다.
...
Git은 다양한 프로토콜을 통해 원격 저장소에 접근할 수 있습니다. 각 프로토콜은 장단점이 있으므로 상황에 맞게 선택하는 것이 중요합니다.
