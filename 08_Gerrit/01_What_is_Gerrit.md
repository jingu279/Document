...
```
  ...
  │                                                          │
  │    ┌──────────────────────────────────────────────────┐  │
  │    │  리뷰 대기열 (Pending Changes)                    │  │
  │    │                                                  │  │
  │    │  Change 123: 로그인 페이지 추가 (PS2) [+2 CR]    │  │
  │    │  Change 124: 결제 API 연동 (PS1)  [-1 V]         │  │
  │    │  Change 125: 문서 수정 (PS3)       [NEW]         │  │
  │    └──────────────────────────────────────────────────┘  │
  │              │                    ▲                       │
  │              │ 리뷰어 승인        │ Submit 버튼           │
  │              ▼                    │                       │
  ...
  │  개발자 로컬 저장소                                      │
  │                                                          │
  │  feature/login 브랜치: C1 ── C2 (Change-Id: I123...)    │
  │  $ git commit --amend → PS2                             │
